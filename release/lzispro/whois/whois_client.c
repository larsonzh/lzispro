...
#include <limits.h>
#include <stdint.h>
#define USER_AGENT "User-Agent: lzispro/3.1 (+https://gitee.com/larsonzh/lzispro)\r\n"
...
void init_caches() {
    ...
    if (connection_cache) {
        ...
        allocated_connection_cache_size = g_config.connection_cache_size;  // 设置分配的大小
...
int send_query(int sockfd, const char *query) {
    ...
    send(sockfd, USER_AGENT, strlen(USER_AGENT), 0);   /* 先发 UA */
