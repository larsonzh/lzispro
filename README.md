...
项目内置自定义的多个基于 Linux 系统环境，无外部依赖的轻量级高性能 whois 客户端（C 语言实现），涵盖 x86|x86_64|armv6|armv7|aarch64|mipsel|mips64el|loongarch64 平台架构，并提供 Windows 下 Git Bash 一键远程静态交叉编译与可选 QEMU 冒烟测试的脚本。
